...
class Bambora_Online_Checkout_Api {
	 ...
	 * @return mixed
	 */
	public function set_checkout_session( Bambora_Online_Checkout_Request $bambora_checkout_request ) {
	 ...
	 * @return mixed
	 */
	public function get_response_code_data( string $source, string $actionCode ) {
